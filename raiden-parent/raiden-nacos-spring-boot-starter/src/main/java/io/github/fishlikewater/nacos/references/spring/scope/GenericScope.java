 ...
 */
package io.github.fishlikewater.nacos.references.spring.scope;
...
public class GenericScope
    ...
    public void destroy() {
        ...
        if (!errors.isEmpty()) {
            throw wrapIfNecessary(errors.getFirst());
        }
        this.errors.clear();
    }
    ...
    private record BeanLifecycleWrapperCache(ScopeCache cache) {
    ...
    public static class LockedScopedProxyFactoryBean<S extends GenericScope> extends ScopedProxyFactoryBean
        ...
        @Override
        public void setTargetBeanName(@NonNull String targetBeanName) {
