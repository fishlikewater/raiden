 ...
 * {@code Assert}
 *
 * @author Keith Donald, Juergen Hoeller, Sam Brannen, Colin Sampaleanu, Rob Harrop
 * @version 1.0.0
 * @since 2024/04/30
 */
...
public class Assert {
    ...
    public static void doesNotContain(String textToSearch, String substring) {
        doesNotContain(textToSearch, substring,
                () -> StringUtils.format("[Assertion failed] - this String argument must not contain the substring [{}]", substring));
    }
    ...
    private static void instanceCheckFailed(Class<?> type, Object obj, String msg) {
        ...
        if (defaultMessage) {
            result = StringUtils.format("{} Object of class [{}] must be an instance of {}", result, className, type);
        }
    ...
    private static void assignableCheckFailed(Class<?> superType, Class<?> subType, String msg) {
        ...
        if (defaultMessage) {
            result = StringUtils.format("{} {} is not assignable to {}", result, subType, superType);
        }
        throw new IllegalArgumentException(result);
    }
